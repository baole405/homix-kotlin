...
import com.exe202.nova.data.model.FeeTypeCategory
...
val MOCK_MANAGER_BILLS = listOf(
    ManagerBill(
        ...
        feeType = FeeTypeCategory.ELECTRICITY,
        apartmentUnit = "A101",
        apartmentBlock = "A",
        residentName = "Nguyễn Văn An"
    ),
    ...
    ManagerBill(
        ...
        feeType = FeeTypeCategory.MANAGEMENT,
        apartmentUnit = "B301",
        apartmentBlock = "B",
        residentName = "Lê Minh Cường"
    ),
    ...
    ManagerBill(
        ...
        period = "02/2026",
        status = BillStatus.PENDING,
        feeType = FeeTypeCategory.PARKING,
        apartmentUnit = "C501",
        apartmentBlock = "C",
        residentName = "Hoàng Văn Em"
    ),
    ManagerBill(
        ...
        period = "02/2026",
        status = BillStatus.PENDING,
        feeType = FeeTypeCategory.INTERNET,
        apartmentUnit = "C602",
        apartmentBlock = "C",
        residentName = "Vũ Thị Phương"
    ),
    ...
    ManagerBill(
        ...
        period = "02/2026",
        status = BillStatus.PENDING,
        feeType = FeeTypeCategory.SERVICE,
        apartmentUnit = "A203",
        apartmentBlock = "A",
        residentName = "Trần Thị Bích"
    ),
